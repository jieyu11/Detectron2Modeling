...
def main():
	...
	parser.add_argument(
		"--trainjson", "-tj", default="coco-manager/person_sportsball_train2014.json",
		type=str, required=False,
	...
	parser.add_argument("--yamlfile", "-y", default=None,
		type=str, required=False,
		help="Yaml file for retraining.",
	)
	parser.add_argument("--weightfile", "-w", default=None,
		type=str, required=False,
		help="Weight file for retraining.",
	)
	...
	parameters = {}
	if args.yamlfile:
		parameters["yamlfile"] = args.yamlfile
	if args.weightfile:
		parameters["weightfile"] = args.weightfile
	rt.set_config(parameters)
...
if __name__ == "__main__":
	# run for example:
	# python retrain_person_sportsball.py -c "person" "sports ball"
	main()